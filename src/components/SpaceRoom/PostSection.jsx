...
export default function PostSection({ eventSpaceId, onPostCreated, spaceCode }) {
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: `Join my space - SpaceCode: ${spaceCode}`,
          text: `Remember this? Enter this code for access: ${spaceCode}`,
          url: shareUrl,
        })
      } else {
  ...
  return (
    <div className='flex flex-col'>
      <div className="bg-[#ece7e3] p-3 px-5 flex flex-row flex-nowrap justify-center items-center gap-3
